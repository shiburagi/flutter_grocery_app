...
class _OrderPlacePageState extends State<OrderPlacePage> {
                  ...
                  Container(
                    ...
                    child: isConfirm
                        ? OutlinedButton(
                            onPressed: () {},
                            child: Text(
                                S.of(context).contactsupport.toUpperCase()),
                          )
                        : ElevatedButton(
                            ...
                            child:
                                Text(S.of(context).cancelorder.toUpperCase())),
                  ),
                  SizedBox(
                    height: 8,
                  ),
  ...
  Widget buildStatus(CartState state) {
    return isConfirm
        ? Stack(
            children: [
              ...
              Center(
                ...
                child: Container(
                  ...
                  child: Text(widget.order.estimateDuration),
                ),
              )),
            ],
          )
